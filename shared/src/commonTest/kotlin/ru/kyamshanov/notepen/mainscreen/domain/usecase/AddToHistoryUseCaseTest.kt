...
class AddToHistoryUseCaseTest {
     ...
     */
    @Test
    fun safFuzzyMatch_sameName_sameSize_differentUri_returnsDetected() =
        runTestBlocking {
            val existing =
                makeFile(
                    id = "existing-id",
     ...
     */
    @Test
    fun safFuzzyMatch_nullFileSize_noFuzzyMatch() =
        runTestBlocking {
            val existing =
                makeFile(
                    id = "existing-id",
     ...
     */
    @Test
    fun safFuzzyMatch_incomingNullSize_existingHasSize_noFuzzyMatch() =
        runTestBlocking {
            val existing =
                makeFile(
                    uri = "content://provider/document/100",
     ...
     */
    @Test
    fun safFuzzyMatch_differentDisplayName_noFuzzyMatch() =
        runTestBlocking {
            val existing =
                makeFile(
                    uri = "content://provider/document/100",
     ...
     */
    @Test
    fun existingUri_returnsMoved_upsertCalledWithLastPageIndex() =
        runTestBlocking {
     ...
     */
    @Test
    fun newUri_emptyHistory_returnsAdded() =
        runTestBlocking {
     ...
     */
    @Test
    fun safFuzzyMatch_bothNullSize_noFuzzyMatch() =
        runTestBlocking {
            val existing =
                makeFile(
                    uri = "content://provider/document/100",
