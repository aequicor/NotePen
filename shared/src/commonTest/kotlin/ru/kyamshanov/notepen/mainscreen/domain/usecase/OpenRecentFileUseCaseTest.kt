...
class OpenRecentFileUseCaseTest {
     ...
     */
    @Test
    fun notFound_returnsNotAvailable() =
        runTestBlocking {
     ...
     */
    @Test
    fun fileError_returnsNotAvailable() =
        runTestBlocking {
     ...
     */
    @Test
    fun checkSync_securityException_returnsFileError() =
        runTestBlocking {
            val throwingChecker =
                object : FileAvailabilityChecker {
                    override suspend fun check(uri: String): AvailabilityStatus = AvailabilityStatus.AVAILABLE

                    override fun checkSync(uri: String): AvailabilityStatus = throw SecurityException("SAF permission revoked")
                }
