...
Конституция агента для KMP + Ktor проекта **NotePen**.
...
4. **Тестирование интерфейсов** — субагент `interface-tester`: UI-автопилот (Compose/Android/iOS) .
...
Подхватываются автоматически по описанию: security-review, interface-testing, docs-on-demand, kotlin-build.
