...
Операционный конституционный файл для работы над **NotePen** в параллельных
...
> для iOS-симулятора всегда передавай UDID явно. В strict-режиме незаскоупленные команды устройств блокирует хук `guard-device`.
...
**3** и включи `org.gradle.parallel`, `org.gradle.caching`,
