(function () {
  ...
  var i18n = {
    ru: {
      ...
      navSync: "Библиотека и синхронизация",
      ...
      writingTitle: "Удобное письмо и заметки",
      writingLead: "Пишите пером так, как привыкли на бумаге, и держите почерк аккуратным.",
      wTabletTitle: "Графический планшет и стилус",
      wTabletDesc: "Перо понимает нажим и наклон, кнопку на корпусе и ластик-наконечник. На Windows работают планшеты Wacom и совместимые через WinTab, на macOS перо подключается напрямую, на Android пишет встроенный стилус.",
      wLoupeTitle: "Лупа для письма",
      wLoupeDesc: "Пишите в плавающей панели крупно и спокойно, а чернила ложатся на страницу мелко и точно. Лупа сама едет вдоль строки, так что писать получается быстро. Её можно закрепить на месте, и она дотягивается даже через границу страницы. Включается с панели инструментов.",
      ...
      libsyncTitle: "Библиотека и синхронизация",
      libsyncLead: "Все документы под рукой, а заметки одни и те же на всех устройствах.",
      libraryTitle: "Ваша библиотека",
      libraryDesc: "Все документы в одном месте. На главном экране видны недавние файлы, папки и обложки страниц. Откройте PDF или книгу EPUB либо FB2, и она станет страницами, по которым можно писать. Всё остаётся на вашем устройстве, аккаунт не нужен.",
      syncTitle: "Заметки на всех устройствах",
      syncDesc: "Заметки остаются одинаковыми на всех ваших устройствах в одной сети. Начните на планшете и продолжите на компьютере. Без облака и без аккаунта.",
      syncDesc2: "Чтобы связать два устройства, покажите QR-код на одном и отсканируйте его на другом.",
    ...
    en: {
      ...
      writingTitle: "Comfortable writing and notes",
      writingLead: "Write with a pen the way you would on paper, and keep your handwriting neat.",
      wTabletTitle: "Graphics tablet and stylus",
      wTabletDesc: "The pen reads pressure and tilt, the side button, and the eraser tip. On Windows, Wacom and compatible tablets work through WinTab. On macOS the pen connects directly. On Android the built-in stylus writes.",
      wLoupeTitle: "Writing loupe",
      wLoupeDesc: "Write large and relaxed in a floating panel while the ink lands small and precise on the page. The loupe follows along the line, so you keep writing without stopping. You can pin it in place, and it reaches even across a page boundary. Turn it on from the tool rail.",
      ...
      libsyncTitle: "Library and sync",
      libsyncLead: "All your documents in one place, and the same notes on every device.",
      libraryTitle: "Your library",
      libraryDesc: "All your documents in one place. The home screen shows recent files, folders, and page covers. Open a PDF or an EPUB or FB2 book, and it becomes pages you can write on. Everything stays on your device, and no account is needed.",
      syncTitle: "Notes on every device",
      syncDesc: "Your notes stay the same on all your devices on the same network. Start on a tablet and keep going on the desktop. No cloud and no account.",
      syncDesc2: "To pair two devices, show a QR code on one and scan it on the other.",
