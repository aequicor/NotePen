...
actual class PdfViewerState internal constructor(
    ...
    actual fun clearTransientViewportEffects() {
        // Android has no spring overscroll layer outside committed pan.
    }
     ...
     * PDF-битмапа не должно расти выше cap (выше — GPU-апскейл), иначе коммит
     * зума за cap триггерил бы бесполезный ре-рендер.
     */
