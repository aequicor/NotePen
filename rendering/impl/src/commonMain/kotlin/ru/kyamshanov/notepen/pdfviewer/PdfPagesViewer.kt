...
expect class PdfViewerState {
    ...
    /**
     * Запрашивает «fit-to-width + центрирование» на странице [pageIndex],
     * применяемое после ближайшего пере-layout'а (смена режима разворота
     * [spreadMode] / разделения страниц). Зум подбирается так, чтобы ряд
     * раскладки занял ширину вьюпорта (в развороте — обе страницы пары рядом),
     * ряд центрируется по горизонтали, а верх [pageIndex] прижимается к верху.
     *
     ...
     */
    fun requestFitToWidth(pageIndex: Int)
