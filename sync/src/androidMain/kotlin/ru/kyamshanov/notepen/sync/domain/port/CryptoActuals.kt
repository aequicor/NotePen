...
// Android implementation of the crypto primitives declared in
// CryptoPrimitives.kt (commonMain). It is byte-for-byte identical to the JVM
// actual: Android ships the same JCA (`javax.crypto` / `java.security`) and this
// module has no shared jvm+android source set, so the actuals are duplicated on
// purpose (mirrors the FileTransferActuals/SqlDelightActuals expect/actual pairs).
