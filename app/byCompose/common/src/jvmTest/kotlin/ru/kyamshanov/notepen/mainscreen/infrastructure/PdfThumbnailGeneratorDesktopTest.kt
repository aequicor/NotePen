...
class PdfThumbnailGeneratorDesktopTest {
    ...
    @Test
    fun `non-existent file returns failure with ThumbnailGenerationException`() = runTest {
    ...
    @Test
    fun `empty path returns failure`() = runTest {
    ...
    @Test
    fun generate_invalidDimensions_returnsFailure() = runTest {
    ...
    @Test
    fun generate_dimensionsTooLarge_returnsFailure() = runTest {
