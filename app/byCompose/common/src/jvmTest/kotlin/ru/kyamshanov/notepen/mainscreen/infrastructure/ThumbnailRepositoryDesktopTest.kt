...
class ThumbnailRepositoryDesktopTest {
    ...
    @Test
    fun `put then get with same mtime returns cached data`() =
        runTest {
    ...
    @Test
    fun `get with different mtime invalidates cache and returns null`() =
        runTest {
    ...
    @Test
    fun `get for uncached uri returns null`() =
        runTest {
    ...
    @Test
    fun `totalSizeBytes increases after put`() =
        runTest {
