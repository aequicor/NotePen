...
class JvmImageDocumentLoaderTest {
    ...
    private fun writeTempPng(width: Int, height: Int): String {
    ...
    @Test
    fun loads_png_as_single_page_document() = runTest {
        val path = writeTempPng(120, 80)
        val loader = JvmDocumentLoader(
