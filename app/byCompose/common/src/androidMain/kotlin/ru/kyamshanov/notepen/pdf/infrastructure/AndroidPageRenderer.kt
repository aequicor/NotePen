...
/**
 * Композитный [PdfPageRenderer] для Android: по типу документа делегирует рендеринг
 * либо [AndroidImagePageRenderer] (для [ImageBackedDocument]), либо [AndroidPdfPageRenderer] (PDF).
 */
