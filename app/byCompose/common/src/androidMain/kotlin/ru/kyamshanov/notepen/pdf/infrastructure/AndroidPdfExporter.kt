...
class AndroidPdfExporter(private val ioDispatcher: CoroutineDispatcher) : PdfExporter {
    ...
    private fun drawPaths(canvas: Canvas, paths: List<DrawingPath>, w: Float, h: Float) {
    ...
    private fun toCatmullRomPath(points: List<DrawingPoint>, w: Float, h: Float): Path = Path().apply {
