...
sealed class MainScreenIntent {
     ...
     * @property id UUID папки.
     */
    data class RequestDeleteFolder(
        val id: String,
    ) : MainScreenIntent()
     ...
     */
    data class RemoveFileFromFolder(
        val folderId: String,
        val uri: String,
    ) : MainScreenIntent()
     ...
     */
    data class FolderDialogNameChanged(
        val name: String,
    ) : MainScreenIntent()
     ...
     */
    data class ExternalFilesDroppedOnLibrary(
