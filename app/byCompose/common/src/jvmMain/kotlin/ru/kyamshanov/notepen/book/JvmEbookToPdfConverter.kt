 ...
 */
class JvmEbookToPdfConverter(private val ioDispatcher: CoroutineDispatcher) : EbookToPdfConverter {
        ...
        mutex.withLock {
            ...
            try {
                when (val parsed = readBookSource(source.readBytes(), format)) {
                    ...
                    is BookSource.Comic -> JvmComicPdfRenderer.render(parsed.images, tmp)
                }
